...
async function main() {
  ...
  // Deploy Sollar NFT Collection contract
  const NFTContract = await ethers.getContractFactory("SollarCollection");
  ...
  console.log("Sollar NFT contract deployed at:\n", nftContract.address);
  console.log("Sollar market ontract deployed at:\n", marketContract.address);
