...
!developmentChains.includes(network.name)
  ? describe.skip
  : describe("Sollar market Auction Logic Unit Tests", () => {
      let owner;
      let nftContract;
      let marketContract;
      let erc20Mock;
      ...
      describe("startAuction()", () => {
        before(async () => {
          ...
          // Deploy Sollar market contract
          const MarketContract = await ethers.getContractFactory("SollarMarket");
        ...
        it("should revert if startTime is less or equal to endTime", async () => {
          ...
          await expect(
            ...
            marketContract,
            "SollarMarket_InvalidAuctionPeriod"
          );
        });
        ...
        it("should revert if startPrice is zero", async () => {
          ...
          await expect(
            ...
            marketContract,
            "SollarMarket_InvalidStartPrice"
          );
        });
        it("should revert if directBuyPrice is less than startPrice", async () => {
          ...
          await expect(
            ...
            marketContract,
            "SollarMarket_InvalidDirectBuyPrice"
          );
        });
      });
      describe("bid()", () => {
        describe("ERC20 token payment", () => {
          ...
          it("should not allow user to bid if already highest bidder", async () => {
            ...
            await expect(
              ...
              marketContract,
              "SollarMarket_AlreadyHighestBid"
            );
          });
        ...
        describe("Auction with no bidders", () => {
          ...
          it("should not allow auction end before endTime", async () => {
            await expect(
              ...
              marketContract,
              "SollarMarket_AuctionPeriodNotEnded"
            );
          });
          let endEvent;
