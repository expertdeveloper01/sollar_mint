...
!developmentChains.includes(network.name)
  ? describe.skip
  : describe("Sollar Buy Offer Logic Unit Tests", () => {
      let owner;
      let nftContract;
      let marketContract;
      let erc20Mock;
      ...
      describe("makeOffer()", () => {
        describe("ERC20 token payment offer", () => {
          ...
          it("should not allow user to make offer on non Sollar token", async () => {
          ...
          it("should revert when expiration time is in the past", async () => {
            ...
            await expect(
              ...
              marketContract,
              "SollarMarket_InvalidExpirationTime"
            );
          });
          it("should revert when offer price is not approved for market", async () => {
            await expect(
              ...
              marketContract,
              "SollarMarket_OfferAmountNotApproved"
            );
          });
          it("should allow user to make offer on existing Sollar token", async () => {
            await approveERC20(
              randomUser,
              erc20Mock.address,
              price,
        ...
        describe("MATIC payment offer", () => {
          ...
          it("should revert when insufficient MATIC amount is sent", async () => {
            ...
            await expect(
              ...
              marketContract,
              "SollarMarket_InsufficientAmount"
            );
          });
          it("should revert when expiration time is in the past", async () => {
            const wrongExpireTime = Math.floor(
